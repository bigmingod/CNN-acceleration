...
/*
void kmeans_cluster(int *cLabel, Dtype *cCentro, Dtype *cWeights, int nWeights, int *mask,  int nCluster,  int max_iter) 
*/

using namespace std;
template<typename Dtype>
void kmeans_cluster(/*int * */vector<int> &cLabel, vector<Dtype> &/*Dtype * */cCentro, Dtype *cWeights, int nWeights, /*int *mask*/vector<int> &mask, /*Dtype maxWeight, Dtype minWeight,*/  int nCluster,  int max_iter /* = 1000 */)
{
    //find min max
